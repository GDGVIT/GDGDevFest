        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col  m5 s12 custom-padding">
                    ...
                    <div class="col m8 s10 push-s2 white-text where-content">
...
<!-- Our Patrons -->
  <div class="row patrons">
    ...
    <div class="col s4 center"><img src="images/vpa_small.jpg" class="rounded" style="border-radius:100% !important;"><br>Sankar Viswanathan</div>
    <div class="col s4 center"><img src="images/vpua_small.jpg" class="rounded"><br>Sekhar Vishwanathan</div>
    <div class="col s4 center"><img src="images/vpc_small.jpg" class="rounded"><br>G. V. Selvam</div>

    <div class="col s4 center"><img src="images/v_raju.JPG" class="rounded"><br>Prof. V. Raju</div>
    <div class="col s4 center"><img src="images/provc.jpg" class="rounded"><br>Prof. S. Narayan</div>
    <div class="col s4 center"><img src="images/anand.jpg" class="rounded"><br>Dr. Anand A. Samuel</div>
  </div>
<!-- End of Patrons! -->
<!--Sponsors-->
    ...
    <footer class="page-footer custom-blue">
        ...
        <div class="row">
          <div class="col s8 push-s2">
            <div class="col m4 center grey-text" style="font-weight:700px;">
              <i style="font-size:24px;" class="grey-text fa fa-envelope"></i><br>
              MAIL<br>
              <a class="grey-text" href="mailto:gdgvitvellore@gmail.com">gdg@vit.ac.in</a>
            </div>
            <div class="col m4 center grey-text" style="font-weight:700px;">
